...
// then limit and scale the BPM value
   BPM = min(BPM,400);   // limit the highest BPM value to 200
   BPM = (BPM)/2;
...
//MAYBE SEND A THING TO ANOTHER FUNCTION?
sendValue(BPM);
//sendValue(heart);

}  //end of draw loop

void sendValue(int BPM){
  OscMessage oscMess1 = new OscMessage("/bpmNum");
  oscMess1.add(BPM);
  
  //OscMessage oscMess2 = new OscMessage("/pulseTrigger");
  //oscMess2.add(heart);
